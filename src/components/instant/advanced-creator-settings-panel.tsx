...
export type InstantDurationDebugInfo = {
...
type Props = {
  ...
  durationDebug?: InstantDurationDebugInfo | null;
    ...
    <div className="mb-4 rounded-2xl border border-zinc-200 bg-zinc-50/90">
      ...
      {open ? (
        <div className="space-y-4 border-t border-zinc-200 px-4 pb-4 pt-3">
          ...
          {props.showAdminDiagnostics && props.durationDebug ?
            <div className="rounded-xl border border-violet-200 bg-violet-50/60 px-3 py-2 text-[11px] font-mono text-violet-950">
              <p>{t("instant.storyboard.admin.storyboardDuration", { seconds: props.durationDebug.storyboardDurationSeconds })}</p>
              <p>{t("instant.storyboard.admin.providerDuration", { seconds: props.durationDebug.providerDurationSeconds })}</p>
              <p>{t("instant.storyboard.admin.scale", { scale: props.durationDebug.durationScale.toFixed(3) })}</p>
              <p>{t("instant.storyboard.admin.segments", { count: props.durationDebug.segmentCount })}</p>
              <p>{t("instant.storyboard.admin.images", { count: props.durationDebug.imageCount })}</p>
            </div>
          : null}
