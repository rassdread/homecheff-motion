...
const STATE_MESSAGE_KEYS: Record<HomeCheffOrbitLoaderState, string> = {
  analyzing: "editor.orbit.analyzing",
  preparing_plan: "editor.orbit.preparingPlan",
  generating: "editor.orbit.generating",
  preparing_motion: "editor.orbit.preparingMotion",
  exporting: "editor.orbit.exporting",
  loading: "editor.orbit.loading",
};

const SIZE_PX = { sm: 56, md: 88, lg: 120 } as const;
...
export function HomeCheffOrbitLoader({
  ...
  return (
    ...
    >
      ...
      <p className="max-w-xs text-center text-sm font-medium text-zinc-800">{label}</p>
      <style jsx>{`
