...
export const en: LocaleSchema = {
  ...
  "instant.progress.stage.mergeClips": "Merging clips…",
  ...
  "instant.exportFailure.generic": "Final video export failed. See details below or try rebuild.",
  "instant.exportFailure.overlay": "Locked text overlay failed during final export.",
  "instant.exportFailure.merge": "Merging segment clips into the final video failed.",
  ...
  "instant.progress.operation.repair": "Recovering final video…",
  "instant.progress.operation.rebuild": "Rebuilding final video…",
  ...
  "instant.progress.exportStuckHint":
    "No progress update for {seconds} seconds during export. Try recover or rebuild.",
