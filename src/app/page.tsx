  ...
  return (
    <main className={`flex-1 ${brand.softGradientBg}`}>
      <section className="mx-auto flex w-full max-w-6xl flex-col px-6 py-16 sm:px-10 sm:py-20">
        <AppCard className="mx-auto w-full max-w-4xl bg-white/90 p-8 text-center shadow-[0_20px_60px_-30px_rgba(16,185,129,0.35)] sm:p-12">
          <div className="mx-auto mb-5 flex w-fit items-center gap-3 rounded-full border border-emerald-100 bg-emerald-50/70 px-4 py-2">
