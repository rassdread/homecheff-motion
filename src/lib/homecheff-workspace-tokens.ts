...
export const workspaceVisual = {
  ...studioVisual,
  shellBg: `studio-page-bg ${growthSidebarLayoutClasses.pageFloorFlex} text-zinc-100`,
  topBar:
  ...
  leftPanel:
    "hidden lg:flex lg:flex-col lg:gap-3 lg:overflow-y-auto lg:max-h-[calc(100dvh-var(--studio-header-height)-3rem)]",
