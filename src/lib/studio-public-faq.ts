...
export const STUDIO_PUBLIC_FAQ: StudioFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Paid subscriptions: Creator €7.99/mo, Pro €24.99/mo, Studio €79.99/mo (yearly options on Pricing). They primarily add storage tiers and credit-pack discounts.",
    legalSource: "studio-subscription-prices / studio-plan-config",
  },
  {
    id: "plan-hc",
    question: "How much HC does each plan provide each month?",
    answer:
      "Current Studio plan SSOT grants 0 monthly Studio Credits on Creator/Pro/Studio. Credits come from credit packs (and any promotions). Subscribers get pack discounts (10%/15%/20%).",
  },
  {
    id: "hc-accumulate",
