...
function handoffFixture(): MotionHandoffPayload {
  return {
    ...
    characterMemory: [],
    locationMemory: { id: "loc-1", name: "Kitchen", slug: "kitchen" } as unknown as MotionHandoffPayload["locationMemory"],
    propMemory: [],
    worldMemory: { id: "w1", name: "HomeCheff World" } as unknown as MotionHandoffPayload["worldMemory"],
    ...
    scenes: [
      {
        ...
        description: "",
        location: null,
        characters: [{ id: "chef", name: "Chef" } as unknown as MotionHandoffPayload["scenes"][number]["characters"][number]],
        props: [],
        action: "wave",
        emotion: "happy",
        camera: "wide",
