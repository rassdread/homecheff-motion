...
export const STUDIO_MOTION_HANDOFF_FIELD_AUDIT: StudioHandoffFieldAuditRow[] = [
  ...
  { field: "storyIntelligence", status: "stored", notes: "Studio-only; not on handoff payload." },
  { field: "aiDirectorDirection", status: "stored", notes: "Storyboard aiDirectorPrompt → aiDirectorNotes on V11 handoff." },
  ...
  { field: "transitionToNext", status: "ignored", notes: "Not sent to Vidu (transition timing from Motion wizard)." },
];
